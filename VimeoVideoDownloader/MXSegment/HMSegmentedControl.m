...
- (void)commonInit {
    ...
    self.selectionIndicatorBoxLayer.cornerRadius = 0.5;
   // self.selectionIndicatorBoxLayer.borderColor = (__bridge CGColorRef _Nullable)([UIColor redColor]);
...
- (void)drawRect:(CGRect)rect {
    ...
    self.selectionIndicatorBoxLayer.borderColor = [UIColor redColor].CGColor;//self.selectionIndicatorBoxColor.CGColor;
    self.selectionIndicatorBoxLayer.cornerRadius = 20.0f;
    self.selectionIndicatorBoxLayer.borderWidth = 1.0f;
